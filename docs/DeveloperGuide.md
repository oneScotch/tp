...
- [Documentation, logging, testing, configuration, dev-ops](#faq) 
- [Appendix: Requirements](command-summary)
  - [Product scope](#listing-all-tasks)
  - [User stories](#marking-a-task-as-done)
  - [Use cases](#locating-tasks-by-keyword)
  - [Non-Functional Requirements](#deleting-a-task)
  - [Glossary](#deleting-a-task)
- [Appendix: Instructions for manual testing](command-summary)
  - [UI component](#adding-a-task)
  - [Logic component](#listing-all-tasks)
  - [Model component](#marking-a-task-as-done)
